 ...
 */
final class Version20190923150900 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE answers (id INT NOT NULL, question_id INT NOT NULL, content TEXT NOT NULL, status BOOLEAN NOT NULL, PRIMARY KEY(id))');
